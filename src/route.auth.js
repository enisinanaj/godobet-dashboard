...
const FrogotPassword = React.lazy(() => import('./Dashboard/Authentication/FrogotPassword/FrogotPassword'));
...
const route = [
    ...
    { path: '/auth/forgot-password', exact: true, name: 'Forgot Password', component: FrogotPassword },
];
