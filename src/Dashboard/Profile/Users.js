                    ...
                    <Card>
                      ...
                      <Card.Body className="text-center">
                        ...
                        <p>
                          ...
                          elit. Adipisci a, rem accusantium recusandae beatae.
                        </p>
                      </Card.Body>
                    ...
                    <Card>
                      <Card.Body className="p-0">
                        <div className="widget-main-card blur-user-card">
                          ...
                          <button className="btn waves-effect waves-light btn-info m-t-30">
                            + Follow
                          </button>
                        ...
                        <Row className="align-items-center">
                          <Col>
                            <Row className="align-items-center">
                              <Col sm="auto" className="pr-0">
                                <img
                                  className="img-radius img-fluid wid-60"
                                  src={avatar2}
                                  alt="User"
                                />
                              </Col>
