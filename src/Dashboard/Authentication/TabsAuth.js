...
class TabsAuth extends React.Component {
  ...
  render() {
    ...
    const blockSignInClass = !this.state.isAuth
      ? [...blockClass, "collapse"]
      : blockClass;
    const blockSignUpClass = this.state.isAuth
      ? [...blockClass, "collapse"]
      : blockClass;
              ...
              <div className="card-body">
                ...
                <div className={blockSignInClass.join(" ")}>
                  <ol className="position-relative carousel-indicators justify-content-center">
                    <li
                      className={authSignInClass}
                      onClick={this.authSignInHandler}
                    />
                    <li
                      className={authSignUpClass}
                      onClick={this.authSignUpHandler}
                    />
                  </ol>
                  ...
                  <button className="btn  btn-outline-primary mb-4 toggle-btn">
                    Create Profile
                  </button>
