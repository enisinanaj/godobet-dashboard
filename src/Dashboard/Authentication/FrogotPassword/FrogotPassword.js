...
class FrogotPassword extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    auth
      .sendPasswordResetEmail(this.state.formFrogotPassword.email)
      .then((e) => {
        alert(
          "Ti abbiamo mandato una mail con le istruzioni per recuperare la tua password"
        );
      })
      .catch((e) => {
        console.error(e);
              ...
              <div className="row align-items-center text-center">
                <div className="col-md-12">
                  ...
                  >
                    ...
                    <p className="mb-3 f-w-400">
                      Inserisci il tuo indirizzo email per ricevere le
                      istruzioni su come resettare il tuo account.
                    </p>
...
export default withRouter(
  connect(mapStateToProps, mapDispatchToProps)(FrogotPassword)
);
