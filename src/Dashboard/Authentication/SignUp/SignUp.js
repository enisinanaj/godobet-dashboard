                            ...
                            <div className="row align-items-center text-center">
                                <div className="col-md-12">
                                    ...
                                    <ValidationForm onSubmit={this.handleSubmit} onErrorSubmit={this.handleErrorSubmit}>
                                            ...
                                            <button className="btn btn-primary btn-block mb-4">Registrati</button>
                                            <p className="mb-2">Hai già un account? <NavLink to="/auth/signin-1" className='f-w-400'>Entra</NavLink></p>
                                        </ValidationForm>
                                    </div>
                                </div>
                            </div>
