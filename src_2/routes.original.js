...
const DashboardAnalytics = React.lazy(() =>
  import("./Demo/Dashboard/Analytics")
);
const DashboardProject = React.lazy(() => import("./Demo/Dashboard/Project"));

const LayoutHorizontal = React.lazy(() =>
  import("./Demo/PageLayout/Horizontal")
);
const LayoutHorizontalV2 = React.lazy(() =>
  import("./Demo/PageLayout/HorizontalL2")
);
const LayoutHorizontalRtl = React.lazy(() =>
  import("./Demo/PageLayout/HorizontalRtl")
);
const LayoutStatic = React.lazy(() =>
  import("./Demo/PageLayout/Vertical/Static")
);
const LayoutFixed = React.lazy(() =>
  import("./Demo/PageLayout/Vertical/Fixed")
);
const LayoutNavFixed = React.lazy(() =>
  import("./Demo/PageLayout/Vertical/NavFixed")
);
const LayoutCollapseMenu = React.lazy(() =>
  import("./Demo/PageLayout/Vertical/CollapseMenu")
);
const LayoutBox = React.lazy(() => import("./Demo/PageLayout/BoxLayout"));
const LayoutRtl = React.lazy(() =>
  import("./Demo/PageLayout/Vertical/RtlLayout")
);
...
const HospitalDashboard = React.lazy(() =>
  import("./Demo/Panels/Hospital/Dashboard")
);
const HospitalDepartment = React.lazy(() =>
  import("./Demo/Panels/Hospital/Department")
);
const HospitalDoctor = React.lazy(() =>
  import("./Demo/Panels/Hospital/Doctor")
);
const HospitalPatient = React.lazy(() =>
  import("./Demo/Panels/Hospital/Patient")
);
const HospitalNurse = React.lazy(() => import("./Demo/Panels/Hospital/Nurse"));
const HospitalPharmacist = React.lazy(() =>
  import("./Demo/Panels/Hospital/Pharmacist")
);
const HospitalLaboratory = React.lazy(() =>
  import("./Demo/Panels/Hospital/Laboratory")
);

const PCDashboard = React.lazy(() =>
  import("./Demo/Panels/ProjectNCrm/Dashboard")
);
const PCCustomers = React.lazy(() =>
  import("./Demo/Panels/ProjectNCrm/Customers")
);
...
const MshpDashboard = React.lazy(() =>
  import("./Demo/Panels/Membership/Dashboard")
);
const MshpEmail = React.lazy(() => import("./Demo/Panels/Membership/Email"));
const MshpCountry = React.lazy(() =>
  import("./Demo/Panels/Membership/Country")
);
const MshpCoupons = React.lazy(() =>
  import("./Demo/Panels/Membership/Coupons")
);
const MshpNewsletter = React.lazy(() =>
  import("./Demo/Panels/Membership/Newsletter")
);
const MshpUser = React.lazy(() => import("./Demo/Panels/Membership/User"));
const MshpMembership = React.lazy(() =>
  import("./Demo/Panels/Membership/Membership")
);

const HelpdeskDashboard = React.lazy(() =>
  import("./Demo/Panels/Helpdesk/Dashboard")
);
const HelpdeskCreateTicket = React.lazy(() =>
  import("./Demo/Panels/Helpdesk/CreateTicket")
);
const HelpdeskTicketList = React.lazy(() =>
  import("./Demo/Panels/Helpdesk/TicketList")
);
const HelpdeskTicketDetails = React.lazy(() =>
  import("./Demo/Panels/Helpdesk/TicketDetails")
);
const HelpdeskCustomer = React.lazy(() =>
  import("./Demo/Panels/Helpdesk/Customer")
);

const SchoolDashboard = React.lazy(() =>
  import("./Demo/Panels/School/Dashboard")
);
...
const CryptoDashboard = React.lazy(() =>
  import("./Demo/Panels/Crypto/Dashboard")
);
const CryptoExchange = React.lazy(() =>
  import("./Demo/Panels/Crypto/Exchange")
);
const CryptoWallet = React.lazy(() => import("./Demo/Panels/Crypto/Wallet"));
const CryptoTransaction = React.lazy(() =>
  import("./Demo/Panels/Crypto/Transaction")
);
...
const CryptoInitialCoin = React.lazy(() =>
  import("./Demo/Panels/Crypto/InitialCoin")
);
const CryptoIcoListing = React.lazy(() =>
  import("./Demo/Panels/Crypto/IcoListing")
);

const EcommProduct = React.lazy(() =>
  import("./Demo/Panels/Ecommerce/Product")
);
const EcommProductDetails = React.lazy(() =>
  import("./Demo/Panels/Ecommerce/ProductDetails")
);
const EcommOrder = React.lazy(() => import("./Demo/Panels/Ecommerce/Order"));
const EcommCheckout = React.lazy(() =>
  import("./Demo/Panels/Ecommerce/Checkout")
);
const EcommCart = React.lazy(() => import("./Demo/Panels/Ecommerce/Cart"));
const EcommSellers = React.lazy(() =>
  import("./Demo/Panels/Ecommerce/Sellers")
);
const EcommCustomers = React.lazy(() =>
  import("./Demo/Panels/Ecommerce/Customers")
);
...
const UIBasicCarousels = React.lazy(() =>
  import("./Demo/UIElements/Basic/Carousels")
);
const UIBasicGridSystem = React.lazy(() =>
  import("./Demo/UIElements/Basic/GridSystem")
);
const UIBasicProgress = React.lazy(() =>
  import("./Demo/UIElements/Basic/Progress")
);
const UIBasicModals = React.lazy(() =>
  import("./Demo/UIElements/Basic/Modals")
);
const UIBasicSpinner = React.lazy(() =>
  import("./Demo/UIElements/Basic/Spinner")
);
...
const UIBasicBasicTooltipsPopovers = React.lazy(() =>
  import("./Demo/UIElements/Basic/TooltipsPopovers")
);
const UIBasicBasicOther = React.lazy(() =>
  import("./Demo/UIElements/Basic/Other")
);

const UIAdvanceAlert = React.lazy(() =>
  import("./Demo/UIElements/Advance/Alert")
);
const UIAdvanceDatepicker = React.lazy(() =>
  import("./Demo/UIElements/Advance/Datepicker")
);
const UIAdvanceLightBox = React.lazy(() =>
  import("./Demo/UIElements/Advance/LightBox")
);
const UIAdvanceModal = React.lazy(() =>
  import("./Demo/UIElements/Advance/Modal")
);
const UIAdvanceNotification = React.lazy(() =>
  import("./Demo/UIElements/Advance/Notification")
);
const UIAdvanceNestable = React.lazy(() =>
  import("./Demo/UIElements/Advance/Nestable")
);
const UIAdvancePNotify = React.lazy(() =>
  import("./Demo/UIElements/Advance/PNotify")
);
const UIAdvanceRating = React.lazy(() =>
  import("./Demo/UIElements/Advance/Rating")
);
const UIAdvanceRangeSlider = React.lazy(() =>
  import("./Demo/UIElements/Advance/RangeSlider")
);
const UIAdvanceSlider = React.lazy(() =>
  import("./Demo/UIElements/Advance/Slider")
);
const UIAdvanceSyntaxHighlighter = React.lazy(() =>
  import("./Demo/UIElements/Advance/SyntaxHighlighter")
);
const UIAdvanceTour = React.lazy(() =>
  import("./Demo/UIElements/Advance/Tour")
);
const UIAdvanceTree = React.lazy(() =>
  import("./Demo/UIElements/Advance/Tree")
);

const FormsElements = React.lazy(() => import("./Demo/Forms/FormsElements"));
const FormsAdvance = React.lazy(() => import("./Demo/Forms/FormsAdvance"));
const FormsValidation = React.lazy(() =>
  import("./Demo/Forms/FormsValidation")
);
...
const AppTaskDetails = React.lazy(() =>
  import("./Demo/AppPages/Task/TaskDetails")
);
const AppToDo = React.lazy(() => import("./Demo/AppPages/ToDo/ToDo"));
const AppNotes = React.lazy(() => import("./Demo/AppPages/ToDo/Notes"));
const AppGalleryGrid = React.lazy(() =>
  import("./Demo/AppPages/Gallery/GalleryGrid")
);
const AppMasonryGallery = React.lazy(() =>
  import("./Demo/AppPages/Gallery/MasonryGallery")
);

const ExtensionEditorCkClassic = React.lazy(() =>
  import("./Demo/Extension/Editor/EditorCkClassic")
);
const ExtensionEditorCkBalloon = React.lazy(() =>
  import("./Demo/Extension/Editor/EditorCkBalloon")
);
const ExtensionEditorCkInline = React.lazy(() =>
  import("./Demo/Extension/Editor/EditorCkInline")
);
const ExtensionEditorCkDocument = React.lazy(() =>
  import("./Demo/Extension/Editor/EditorCkDocument")
);
const ExtensionEditorJoditWYSIWYG = React.lazy(() =>
  import("./Demo/Extension/Editor/EditorJoditWYSIWYG")
);
const ExtensionEditorRichNib = React.lazy(() =>
  import("./Demo/Extension/Editor/EditorRichNib")
);
const ExtensionInvoiceBasic = React.lazy(() =>
  import("./Demo/Extension/Invoice/InvoiceBasic")
);
const ExtensionInvoiceSummary = React.lazy(() =>
  import("./Demo/Extension/Invoice/InvoiceSummary")
);
const ExtensionInvoiceList = React.lazy(() =>
  import("./Demo/Extension/Invoice/InvoiceList")
);
const ExtensionFullEventCalendar = React.lazy(() =>
  import("./Demo/Extension/FullEventCalendar")
);
const ExtensionFileUpload = React.lazy(() =>
  import("./Demo/Extension/FileUpload")
);
const ExtensionImageCropper = React.lazy(() =>
  import("./Demo/Extension/ImageCropper")
);
